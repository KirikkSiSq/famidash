...
@instruments:
	...
	.word @env9,@env8,@env41,@env0 ; 01 : hat
	.word @env26,@env23,@env30,@env0 ; 02 : clap no app
	.word @env38,@env23,@env30,@env0 ; 03 : triangle pluck 4
	.word @env44,@env8,@env2,@env0 ; 04 : cymbal
	.word @env21,@env28,@env2,@env0 ; 05 : snare
	.word @env46,@env23,@env35,@env0 ; 06 : Instrument 4
	.word @env54,@env23,@env30,@env0 ; 07 : triangle pluck 2
	.word @env43,@env49,@env30,@env0 ; 08 : (G2) aggressive noise kick + crash
	.word @env36,@env22,@env30,@env0 ; 09 : (G2) aggressive noise kick
	.word @env11,@env42,@env30,@env0 ; 0a : kick
	.word @env20,@env23,@env30,@env0 ; 0b : Instrument 2
	.word @env20,@env8,@env30,@env0 ; 0c : rel hats
	.word @env10,@env23,@env30,@env0 ; 0d : clutterfunk sax
	.word @env1,@env23,@env30,@env0 ; 0e : echo
	.word @env17,@env23,@env5,@env0 ; 0f : electroman lead
	.word @env17,@env23,@env30,@env0 ; 10 : blank
	.word @env3,@env23,@env32,@env0 ; 11 : sample
	.word @env25,@env23,@env30,@env0 ; 12 : infernoplex_piano
	.word @env40,@env23,@env30,@env16 ; 13 : death moon lead 2
	.word @env52,@env23,@env35,@env0 ; 14 : death moon lead
	.word @env51,@env23,@env30,@env0 ; 15 : blank slower string
	.word @env48,@env23,@env30,@env0 ; 16 : menu acc
	.word @env13,@env23,@env6,@env0 ; 17 : endgame lead
	.word @env45,@env23,@env33,@env0 ; 18 : shift string
	.word @env50,@env23,@env30,@env0 ; 19 : blank instant decay
	.word @env18,@env23,@env29,@env15 ; 1a : Kap lead
	.word @env4,@env23,@env24,@env53 ; 1b : every end pluck lead
...
@song2ref152:
	.byte $49, .lobyte(@env47), .hibyte(@env47), $1d, $81, $9a, $29, $81, $00, $81, $22, $81, $22, $81, $25, $81, $29, $81, $00
	.byte $81, $20
	.byte $41, $0f
	.word @song2ref35
	.byte $41, $10
	...
	.byte $41, $10
	.word @song2ref70
	.byte $ae, $22, $00, $29, $81, $00, $81, $25, $00, $22, $00, $25, $00, $29, $81, $00, $81, $9a, $20
	.byte $41, $0f
	.word @song2ref35
	.byte $41, $10
	.word @song2ref53
...
@song2ref223:
	...
	.byte $41, $22
	.word @song2ref223
	.byte $20, $85, $78, $22, $81, $20, $85, $00, $85, $4b, .lobyte(@env39), .hibyte(@env39), $9e, $50, $14, $29, $1d, $89, $4b
	.byte .lobyte(@env23), .hibyte(@env23), $4c, $9a, $1d, $81, $00, $85, $4b, .lobyte(@env39), .hibyte(@env39), $9e, $16, $85
	.byte $4d, $1b, $85, $4d, $a0, $08, $85, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9a, $22, $81, $20, $81, $00, $85, $4b
	.byte .lobyte(@env39), .hibyte(@env39), $9e, $16, $83, $45, $4d, $16, $83, $45, $4d, $14, $83, $45, $4b, .lobyte(@env23)
	.byte .hibyte(@env23), $4c, $9a, $22, $81, $29, $81, $4b, .lobyte(@env39), .hibyte(@env39), $9e, $12, $83, $45, $4d, $11
@song2ref352:
	.byte $83, $45, $4d, $40, $05, $83, $45, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9a, $22, $81, $29, $81, $1d, $8d, $00
	.byte $4b, .lobyte(@env39), .hibyte(@env39), $9e, $50, $11, $29, $1d, $8b, $00, $89, $4d, $20, $81, $4d, $50, $f5, $20, $22
	.byte $81, $43, $16, $45, $4d, $50, $f5, $20, $22, $81, $43, $16
@song2ref402:
	.byte $45, $70, $51, $02, $80, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9a, $2c, $9d, $9c, $2c, $00, $77, $2c, $00, $76
...
@song2ref582:
	...
	.byte $41, $22
	.word @song2ref223
	.byte $20, $85, $78, $22, $81, $20, $85, $00, $85, $4b, .lobyte(@env39), .hibyte(@env39), $9e, $50, $28, $1d, $11, $89, $4b
	.byte .lobyte(@env23), .hibyte(@env23), $4c, $9a, $1d, $81, $00, $85, $4b, .lobyte(@env39), .hibyte(@env39), $9e, $0a, $85
	.byte $4d, $0f, $85, $4d, $a0, $08, $85, $4b, .lobyte(@env23), .hibyte(@env23), $4c, $9a, $22, $81, $20, $81, $00, $85, $4b
	.byte .lobyte(@env39), .hibyte(@env39), $9e, $0a, $83, $45, $4d, $0a, $83, $45, $4d, $08, $83, $45, $4b, .lobyte(@env23)
	.byte .hibyte(@env23), $4c, $9a, $22, $81, $29, $81, $4b, .lobyte(@env39), .hibyte(@env39), $9e, $06, $83, $45, $4d, $05
	.byte $41, $0c
	.word @song2ref352
	.byte $4b, .lobyte(@env39), .hibyte(@env39), $9e, $50, $22, $1d, $11, $8b, $00, $89, $4d, $14, $81, $4d, $50, $ea, $14, $16
...
@song2ref905:
	.byte $96, $40, $0a, $81, $94, $40, $01, $81
@song2ref913:
	.byte $40, $01, $81
@song2ref916:
	.byte $40, $01, $81, $96, $40, $0a, $81, $94, $40, $01, $81, $88, $40, $0a, $83, $45, $96, $40, $0a, $81, $94, $40, $01, $81
	.byte $40, $01, $81, $00, $81, $96, $40, $0a, $81, $00, $81, $78
@song2ref952:
	.byte $40, $0a, $81, $94, $40, $01, $81, $96, $40, $0a, $81, $94, $40, $01, $81, $96, $40, $0a, $81, $94, $40, $01, $75, $81
	.byte $41, $0c
	.word @song2ref905
	.byte $41, $11
	.word @song2ref913
	.byte $41, $21
	.word @song2ref916
	.byte $96, $40, $0a, $81, $94, $40, $01, $81, $00, $9d, $7f, $88
@song2ref997:
...
@song2ref1019:
	...
	.byte $41, $15
	.word @song2ref1009
	.byte $40, $0a, $83, $45, $00, $85, $8a, $03, $81, $00, $89, $88, $40, $0a, $85, $96, $01, $81, $94, $40, $01, $81, $7b, $96
	.byte $01, $81, $94, $40, $01, $81, $96, $01, $81, $94, $40, $01, $81, $78, $96
	.byte $41, $0c
	.word @song2ref952
	.byte $96, $40, $0a, $81, $94, $40, $01, $81, $78, $96
	.byte $41, $0c
	.word @song2ref952
	.byte $96, $40, $0a, $81, $94, $40, $01, $81, $00, $9d, $9f, $9f, $9f, $97, $70, $51, $07, $a0, $a0, $01, $85, $7f, $88
@song2ref1149:
...
@song2ref1302:
	...
	.byte $38, $81, $14, $81, $14, $81, $14, $81, $23, $81, $20, $81, $23, $81, $20, $81, $38, $81, $20, $81, $23, $81, $20, $81
	.byte $23, $81, $13, $81, $23, $81, $1f, $81, $38, $81, $1f, $81, $23, $81, $1f, $81
	.byte $41, $32
	.word @song2ref1302
...
@song3ref63:
	...
	.byte $4f, $02
@song3ref92:
	.byte $aa, $23, $81, $50, $ee, $2f, $3b, $81, $2f, $81, $49, .lobyte(@env19), .hibyte(@env19), $8b, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $aa, $2c, $85, $2a, $81, $28, $81, $2a, $49, .lobyte(@env55), .hibyte(@env55), $85, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $aa, $2c, $81, $2a, $49, .lobyte(@env55), .hibyte(@env55), $89, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa
	.byte $28, $81, $27
@song3ref142:
	.byte $81, $25, $81, $23, $81, $25, $81, $27, $81, $49, .lobyte(@env12), .hibyte(@env12), $28, $81, $49, .lobyte(@env0), .hibyte(@env0)
	.byte $4a, $aa, $27, $81, $25, $81, $23, $81, $25, $81, $23, $81, $25, $81, $2c, $81, $2a, $49, .lobyte(@env55), .hibyte(@env55)
	...
	.byte $4a, $aa, $2f, $81, $2c, $49, .lobyte(@env27), .hibyte(@env27), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa
	.byte $2a, $81, $28
	.byte $41, $09
	.word @song3ref142
	.byte $28, $81, $23, $81, $2c, $49, .lobyte(@env7), .hibyte(@env7), $85, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $2a
	.byte $83, $49, .lobyte(@env37), .hibyte(@env37), $89, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $27, $81, $49, .lobyte(@env37)
	.byte .hibyte(@env37), $83, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $23, $81, $49, .lobyte(@env37), .hibyte(@env37)
	.byte $83, $51, $fd, $70, $49, .lobyte(@env0), .hibyte(@env0), $4a, $aa, $28, $81, $49, .lobyte(@env37), .hibyte(@env37)
...
@song3ref543:
	...
	.byte $41, $12
	.word @song3ref543
	.byte $73, $51, $03, $80, $4e, $01, $4f, $02, $aa, $28, $81, $49, .lobyte(@env37), .hibyte(@env37), $83, $4e, $02, $aa, $50
...
@song3ref705:
	...
	.byte $41, $09
	.word @song3ref705
	.byte $1e, $81, $20, $81, $1b, $81, $7f, $4f, $00, $ac, $28, $85, $72, $4e, $ff, $4f, $02, $9c
	.byte $41, $36
	.word @song3ref399
	.byte $28, $81, $4e, $ff
	.byte $41, $34
...
@song3ref928:
	...
	.byte $9d, $44, $00
@song3ch3:
	.byte $9f, $9f, $9f, $9f, $9f, $9f, $9f, $70, $51, $03, $f0, $a2, $1f, $9b, $81, $7b, $88
@song3ref987:
	.byte $1e
@song3ref988:
	.byte $81, $7a, $98, $20, $81, $7f, $8a, $22, $81, $79, $51, $fc, $40, $90, $14, $83, $7a, $00, $92, $14, $81, $7f, $8a, $22
	.byte $85, $7b, $92, $14
	.byte $41, $0b
	.word @song3ref988
	...
	.byte $81, $00
@song3ref1075:
	.byte $81, $78, $90, $14, $81, $7a, $88, $21, $81, $7f, $8a, $22, $81, $7a, $88, $21, $81, $78, $90, $14, $81, $7a, $88, $21
...
@song4ch3:
	.byte $8f, $88
@song4ref912:
	.byte $20, $85, $45, $8d, $00, $a5, $bf, $bf, $bf, $8f, $a2
@song4ref923:
	...
	.byte $41, $08
	.word @song4ref923
	.byte $88, $20, $85, $45, $8d, $00, $a5, $71, $a2, $2d, $85, $00, $85, $74, $2d, $85, $00, $85, $77, $2d, $85, $00, $85, $7b
	.byte $2d, $85, $00, $85, $7f
@song4ref970:
...
@song4ref987:
	...
	.byte $41, $08
	.word @song4ref987
	.byte $2b, $85, $00, $85, $2b, $85, $72, $a6, $30, $30, $30, $30, $7f, $a2, $2b, $85, $75, $a6, $30, $30, $30, $30, $7f, $a2
	.byte $2b, $85, $78, $a6, $30, $30, $30, $30, $7f, $a2, $2b, $85, $a6, $30, $30, $30, $30, $00, $bd, $88
@song4ref1052:
