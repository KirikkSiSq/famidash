...
@instruments:
	...
	.word @env33,@env22,@env28,@env0 ; 12 : Instrument 1
	.word @env48,@env22,@env28,@env0 ; 13 : menu acc
	.word @env51,@env22,@env28,@env0 ; 14 : blank slower string
	.word @env18,@env22,@env28,@env0 ; 15 : Instrument 2
	.word @env35,@env49,@env30,@env0 ; 16 : octave arp
	.word @env15,@env22,@env28,@env0 ; 17 : DMC: drums + bass
	.word @env20,@env22,@env28,@env0 ; 18 : loud blank string
	.word @env52,@env22,@env34,@env0 ; 19 : death moon lead
	.word @env13,@env22,@env28,@env0 ; 1a : 02 but tri
	.word @env45,@env22,@env31,@env0 ; 1b : shift string
...
@song5ref154:
	...
	.byte $08, $83, $0a, $83, $0e, $83, $11, $81, $84, $27, $27, $27, $92, $27, $81, $1b, $81, $0f, $a2, $50, $b3, $16, $5b, $85
...
@song5ch1:
	...
	.byte $85, $7f, $98, $0f, $81, $03, $81, $0f, $81, $00, $81, $87, $a6
	.byte $41, $0c
	.word @song5ref154
	...
	.byte $98, $17, $81, $0b, $81, $17, $81, $00, $81, $87, $a6
	.byte $41, $0c
	.word @song5ref301
	.byte $86
	.byte $41, $10
